      ...
      builder: (_) => Container(
        ...
        child: Column(
          ...
          children: [
            Center(
              child:
                  Text(recipe['emoji']!, style: const TextStyle(fontSize: 60)),
            ),
            ...
            Text(recipe['ingredients']!,
                style:
                    const TextStyle(fontSize: 13, color: MaaColors.textGrey)),
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              decoration:
                  const InputDecoration(hintText: 'e.g. 60', suffixText: 'kg'),
            ),
            const SizedBox(height: 16),
            SizedBox(
              width: double.infinity,
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                          color: MaaColors.white.withAlpha(200), fontSize: 12),
                    ),
                  ],
                ),
              ),
