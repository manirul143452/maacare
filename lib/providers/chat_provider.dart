...
class ChatProvider extends ChangeNotifier {
  ...
  Future<void> loadConversations(String userId) async {
    ...
    notifyListeners();
    try {
      final conversations = await InsForgeService.instance.fetchConversations(userId);
  ...
  Future<void> loadHistory(String userId, {String? conversationId}) async {
    ...
    notifyListeners();
    try {
      final history = await InsForgeService.instance.fetchChatHistory(userId, conversationId: conversationId);
      _messages.clear();
  ...
  void _addWelcomeMessage() {
    _messages.add(ChatMessage(
      ...
      userId: 'system',
      role: 'assistant',
      content: 'Namaste, Mama! 💕 I\'m Maa, your 24/7 companion. I\'m here to listen, support, and celebrate every step of your journey. How are you feeling today? 🌸',
      createdAt: DateTime.now(),
    ));
  }
